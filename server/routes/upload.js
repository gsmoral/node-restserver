...
// Estos dos son paquetes de node, no se requiere instalar
const fs = require('fs');
const path = require('path');

// default options (Todo lo que se suba lo coloca en el objeto req.files)
app.use(fileUpload());
...
app.put('/upload/:tipo/:id', function(req, res) {
    ...
    // Cambiar nombre al archivo para evitar que sea repetido
